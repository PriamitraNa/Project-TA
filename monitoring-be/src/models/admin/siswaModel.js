...
// Get all students data with pagination, search, gender filter, and sorting
export const getAllDataSiswa = (
  ...
  return new Promise((resolve, reject) => {
    ...
    if (jenisKelamin) {
      // Handle mapping dari frontend (L -> Laki-laki, P -> Perempuan)
      ...
      // Validasi bahwa mapped value adalah valid
...
// Check if NISN or NIK exists in database (for real-time validation)
...
// Check if NISN or NIK exists in database excluding a specific student (for edit validation)
export const checkSingleSiswaWithExclude = (nisn = null, nik = null, excludeId) => {
  return new Promise((resolve, reject) => {
    ...
    db.query(checkStudentQuery, [excludeId], (err, studentResults) => {
      ...
      // Build query to check existing NISN/NIK excluding the current student
...
// Check if multiple NISN or NIK exist in database (for batch validation)
export const checkMultipleSiswa = (nisnList, nikList) => {
  return new Promise((resolve, reject) => {
    ...
    // Build query to check existing NISN and NIK
    const query = `
...
export const bulkCreateSiswa = (siswaData) => {
  return new Promise((resolve, reject) => {
    ...
    // STEP 2: Check duplicates within batch
    ...
    db.query(checkQuery, [...nisnList, ...nikList], (err, results) => {
      ...
      // STEP 4: All validations passed, insert to database
      const insertQuery = `
...
export const updateSiswa = (siswaId, siswaData) => {
  return new Promise((resolve, reject) => {
    ...
    db.query(checkStudentQuery, [siswaId], (err, studentResults) => {
      ...
      // Check NISN duplicate (excluding current student)
      ...
      db.query(checkNisnQuery, [siswaData.nisn.trim(), siswaId], (err, nisnResults) => {
        ...
        // Check NIK duplicate (excluding current student)
...
export const deleteSiswa = (siswaId) => {
  return new Promise((resolve, reject) => {
    ...
    // Check if student exists and get data before delete
