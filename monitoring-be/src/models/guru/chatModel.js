...
/**
 * Get daftar conversations untuk guru dengan search dan sorting
 */
...
/**
 * Get total unread count untuk guru
 */
...
/**
 * Mark messages as read (messages from ortu)
 */
...
/**
 * Update unread count guru jadi 0
 */
...
/**
 * Get last message from guru untuk rate limiting check
 */
...
/**
 * Update conversation last_message dan increment unread_count_ortu
 */
...
/**
 * Get list siswa yang diampu guru untuk new chat
 */
export const getSiswaForNewChat = (guruId, filters) => {
  return new Promise((resolve, reject) => {
    ...
    // Order by has_conversation (false first), then nama_lengkap
    query += `
      ORDER BY 
...
/**
 * Check if guru mengampu siswa (Wali Kelas atau Guru Mapel)
 */
