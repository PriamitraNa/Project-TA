...
// Service to get all orangtua data
export const fetchDataOrtu = async (
  ...
  // Service to get orangtua detail with complete children information (for edit modal)
...
// Service to get available students (students without parents)
export const fetchAvailableStudents = async (search = "", limit = 50, excludeIds = []) => {
  try {
    ...
    // Parse exclude_ids if it's a string
...
// Service to get available students for edit modal (include students already related to current parent)
export const fetchAvailableStudentsForEdit = async (search = "", limit = 50, excludeIds = [], includeIds = []) => {
  try {
    ...
    // Parse include_ids if it's a string
...
// Service to check single NIK orangtua
...
// Service to check single NIK orangtua with exclude (for edit modal)
...
// Service to check multiple NIK orangtua
...
// Service to bulk create orangtua
...
// Service to update orangtua with anak relationships
...
// Service to delete orangtua with anak relationships
