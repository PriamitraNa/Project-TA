...
export const getDataGuru = async (req, res) => {
  ...
  // Controller to get guru detail by ID
...
// Controller to check single NIP
...
// Controller to check multiple NIPs
...
// Controller to bulk create guru
...
// Controller to check single NIP with exclude (for edit)
